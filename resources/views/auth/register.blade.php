                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-6">
                                <input id="fiscal_code" type="text" class="form-control @error('fiscal_code') is-invalid @enderror" name="fiscal_code" value="{{ old('fiscal_code') }}" required autocomplete="name" autofocus>
